...
print("weblog_html:",weblog_html,file=sys.stderr)
...
with open(weblog_html, 'r') as weblog_index_html:
    ...
    if casa_version == '':
        for soup_th in soup.findAll('th', string='CASA Version'):
            print("soup_th:",soup_th) # soup_th.name # soup_th.text
...
if casa_version != '':
	...
	print('CASA version:',casa_version,file=sys.stderr)
	print('Fail to find CASA version in html!!',file=sys.stderr)
